...
function TopBar() {
    ...
    return (
        <>
            <div className={`${visible === false ? 'w-full -translate-y-36 transition-transform duration-300 absolute' : 'w-full translate-y-0 transition-transform duration-300 absolute' } `}>
